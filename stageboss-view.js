import {drawRailDamage,drawRailTrack} from './rail-render129.js?v=303&b=303';
import {fx,fxReady,fxImage} from './fx-art.js?v=303';
import {drawEnemyProjectile} from './projectiles.js?v=303&b=303';
import {drawSupportShip,drawSupportEffects} from './stuttgart-render129.js?v=303';
import {renderStageBossLayer} from './headon-stageboss-render.js?v=303';
import {bossHudModel} from './headon-stageboss-hud.js?v=303&b=303';
...
const bossSources={
 parisGun:'./boss-bruno-train115.webp',lincomparable:'./boss-lincomparable94.webp?v=303&b=303',stuttgart:'./boss-sms-stuttgart94.webp',zubian:'./boss-hms-zubian94.webp',
 l70:'./boss-zeppelin-l7094.webp',hma23:'./boss-hma2394.webp',a7v:'./boss-a7v-flak94.webp',markv:'./boss-mark-v94.webp',gik:'./boss-gik.webp?v=303&b=303',ca4:'./boss-ca4.webp?v=303&b=303',
...
const railWreckSources={
 parisGun:{engine:'./rail-boss-bruno-engine-wreck192.webp?v=303&b=303',front:'./rail-boss-bruno-front-wreck192.webp?v=303&b=303',middle:'./rail-boss-bruno-middle-wreck192.webp?v=303&b=303',rear:'./rail-boss-bruno-rear-wreck192.webp?v=303&b=303'},
 lincomparable:{engine:'./rail-boss-lincomparable-engine-wreck192.webp?v=303&b=303',front:'./rail-boss-lincomparable-front-wreck192.webp?v=303&b=303',middle:'./rail-boss-lincomparable-middle-wreck192.webp?v=303&b=303',rear:'./rail-boss-lincomparable-rear-wreck192.webp?v=303&b=303'}
};
...
const zubianGroup=createLazyImageGroup({atlas:'./zubian-atlas.webp?v=303'}),zubianArt=zubianGroup.images;
...
const cityGroup=createLazyImageGroup({london:'./terrain-city-london96.webp?v=303&b=303',berlin:'./terrain-city-berlin96.webp?v=303&b=303'}),cityArt=cityGroup.images;
