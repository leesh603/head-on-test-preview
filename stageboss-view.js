import {drawRailDamage,drawRailTrack} from './rail-render129.js?v=310&b=310';
import {fx,fxReady,fxImage} from './fx-art.js?v=310';
import {drawEnemyProjectile} from './projectiles.js?v=310&b=310';
import {drawSupportShip,drawSupportEffects} from './stuttgart-render129.js?v=310';
import {renderStageBossLayer} from './headon-stageboss-render.js?v=310';
import {bossHudModel} from './headon-stageboss-hud.js?v=310&b=310';
...
const bossSources={
 parisGun:'./boss-bruno-train115.webp',lincomparable:'./boss-lincomparable94.webp?v=310&b=310',stuttgart:'./boss-sms-stuttgart94.webp',zubian:'./boss-hms-zubian94.webp',
 l70:'./boss-zeppelin-l7094.webp',hma23:'./boss-hma2394.webp',a7v:'./boss-a7v-flak94.webp',markv:'./boss-mark-v94.webp',gik:'./boss-gik.webp?v=310&b=310',ca4:'./boss-ca4.webp?v=310&b=310',
...
const railWreckSources={
 parisGun:{engine:'./rail-boss-bruno-engine-wreck192.webp?v=310&b=310',front:'./rail-boss-bruno-front-wreck192.webp?v=310&b=310',middle:'./rail-boss-bruno-middle-wreck192.webp?v=310&b=310',rear:'./rail-boss-bruno-rear-wreck192.webp?v=310&b=310'},
 lincomparable:{engine:'./rail-boss-lincomparable-engine-wreck192.webp?v=310&b=310',front:'./rail-boss-lincomparable-front-wreck192.webp?v=310&b=310',middle:'./rail-boss-lincomparable-middle-wreck192.webp?v=310&b=310',rear:'./rail-boss-lincomparable-rear-wreck192.webp?v=310&b=310'}
};
...
const zubianGroup=createLazyImageGroup({atlas:'./zubian-atlas.webp?v=310'}),zubianArt=zubianGroup.images;
...
const cityGroup=createLazyImageGroup({london:'./terrain-city-london96.webp?v=310&b=310',berlin:'./terrain-city-berlin96.webp?v=310&b=310'}),cityArt=cityGroup.images;
   ...
   if(h.kind==='beam'){const x2=h.x+Math.cos(h.angle)*h.length,y2=h.y+Math.sin(h.angle)*h.length;
    if(h.visual==='apron-wire'){
     ...
     if(warning){// Fan telegraph only — same style as other bombing warnings, no sprite preview.
      ...
      const jetLen=(h.length-muzzle)*Math.min(1,activeAge/.5),beamH=h.thickness*2.7;
      c.save();c.beginPath();c.rect(muzzle,-beamH/2,jetLen+40,beamH);c.clip();
      c.globalAlpha=.96;c.drawImage(img,muzzle,-beamH/2,h.length-muzzle,beamH);
      c.globalCompositeOperation='screen';c.globalAlpha=.4+Math.sin(h.age*17)*.1;
      c.drawImage(img,muzzle+Math.sin(h.age*23)*6,-beamH*.42,(h.length-muzzle)*.96,beamH*.84);
      c.restore();}
