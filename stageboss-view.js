...
for(const [key,src] of Object.entries({
 parisGun:'./boss-bruno-train115.png',lincomparable:'./boss-lincomparable94.png?v=203&b=203',stuttgart:'./boss-sms-stuttgart94.png',zubian:'./boss-hms-zubian94.png',
 l70:'./boss-zeppelin-l7094.png',hma23:'./boss-hma2394.png',a7v:'./boss-a7v-flak94.png',markv:'./boss-mark-v94.png',gik:'./boss-gik.png?v=203&b=203',ca4:'./boss-ca4.png?v=203&b=203',
...
const cityArt={};
for(const [key,src] of Object.entries({london:'./terrain-city-london96.png?v=203&b=203',berlin:'./terrain-city-berlin96.png?v=203&b=203'})){
