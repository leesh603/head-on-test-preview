...
import {getLocale,subscribe} from './i18n.js?v=320';
import {clearAircraftMatte,aircraftKey} from './aircraft.js?v=320&b=320';
import {clearCrewMatte} from './matte70.js?v=320&b=320';
import {aircraftArt} from './main-ui-art180.js?v=320';
...
const rawHangarArt={fokker:'./fokker.webp?v=320&b=320',baron_albatros:'./baron_albatros.webp?v=320&b=320',albatros_d2:'./albatros_d2.webp?v=320&b=320',nieuport_italian:'./nieuport.webp?v=320&b=320'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.webp?v=320&b=320`;
...
function installHud(){
 ...
 for(const [id,name]of [['touchSkill','active'],['touchEvade','maneuver']]){
  ...
  if(name==='active'){const f=$('central')?.classList.contains('active')?'central':'entente';
   ...
   img.src=`./augmentation-icons/emblem_bare_${f}.webp?v=320`;button.prepend(img,ring());}
