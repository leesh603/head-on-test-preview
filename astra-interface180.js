...
import {getLocale,subscribe} from './i18n.js?v=319';
import {clearAircraftMatte,aircraftKey} from './aircraft.js?v=319&b=319';
import {clearCrewMatte} from './matte70.js?v=319&b=319';
import {aircraftArt} from './main-ui-art180.js?v=319';
...
const rawHangarArt={fokker:'./fokker.webp?v=319&b=319',baron_albatros:'./baron_albatros.webp?v=319&b=319',albatros_d2:'./albatros_d2.webp?v=319&b=319',nieuport_italian:'./nieuport.webp?v=319&b=319'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.webp?v=319&b=319`;
...
function installHud(){
 ...
 for(const [id,name]of [['touchSkill','active'],['touchEvade','maneuver']]){
  ...
  if(name==='active'){const f=$('central')?.classList.contains('active')?'central':'entente';
   ...
   img.src=`./augmentation-icons/emblem_bare_${f}.webp?v=319`;button.prepend(img,ring());}
