...
import {clearAircraftMatte,aircraftKey} from './aircraft.js?v=318&b=318';
...
const rawHangarArt={fokker:'./fokker.webp?v=318&b=318',baron_albatros:'./baron_albatros.webp?v=318&b=318',albatros_d2:'./albatros_d2.webp?v=318&b=318',nieuport_italian:'./nieuport.webp?v=318&b=318'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.webp?v=318&b=318`;
