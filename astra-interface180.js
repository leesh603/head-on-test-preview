...
import {getLocale,subscribe} from './i18n.js?v=300';
import {clearAircraftMatte,aircraftKey} from './aircraft.js?v=300&b=300';
import {clearCrewMatte} from './matte70.js?v=300&b=300';
import {aircraftArt} from './main-ui-art180.js?v=300';
...
const rawHangarArt={fokker:'./fokker.webp?v=300&b=300',baron_albatros:'./baron_albatros.webp?v=300&b=300',albatros_d2:'./albatros_d2.webp?v=300&b=300',nieuport_italian:'./nieuport.webp?v=300&b=300'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.webp?v=300&b=300`;
...
function installHud(){
 ...
 for(const [id,name]of [['touchSkill','active'],['touchEvade','maneuver']]){
  ...
  if(name==='active'){const f=$('central')?.classList.contains('active')?'central':'entente';
   ...
   img.src=`./augmentation-icons/skill_emblem_${f}.webp?v=300`;button.prepend(img,ring());}
