...
import {getLocale,subscribe} from './i18n.js?v=334';
import {clearAircraftMatte,aircraftKey} from './aircraft.js?v=334&b=326';
import {clearCrewMatte} from './matte70.js?v=334&b=326';
import {aircraftArt} from './main-ui-art180.js?v=334';
...
const rawHangarArt={fokker:'./fokker.webp?v=334&b=326',baron_albatros:'./baron_albatros.webp?v=334&b=326',albatros_d2:'./albatros_d2.webp?v=334&b=326',nieuport_italian:'./nieuport.webp?v=334&b=326'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.webp?v=334&b=326`;
...
function installHud(){
 ...
 for(const [id,name]of [['touchSkill','active'],['touchEvade','maneuver']]){
  ...
  if(name==='active'){const f=$('central')?.classList.contains('active')?'central':'entente';
   ...
   img.src=`./augmentation-icons/emblem_bare_${f}.webp?v=334`;button.prepend(img,ring());}
