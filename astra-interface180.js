...
import {getLocale,subscribe} from './i18njs?v=214';
import {clearAircraftMatte,aircraftKey} from './aircraftjs?v=214';
import {clearCrewMatte} from './matte70js?v=214';
import {aircraftArt} from './main-ui-art180js?v=214';
...
const rawHangarArt={fokker:'./fokker.png?v=214&b=214',baron_albatros:'./baron_albatros.png?v=214&b=214',albatros_d2:'./albatros_d2.png?v=214&b=214',nieuport_italian:'./nieuport.png?v=214&b=214'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.png?v=214&b=214`;
