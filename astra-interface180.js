...
const rawHangarArt={fokker:'./fokker.png?v=204&b=204',baron_albatros:'./baron_albatros.png?v=204&b=204',albatros_d2:'./albatros_d2.png?v=204&b=204',nieuport_italian:'./nieuport.png?v=204&b=204'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.png?v=204&b=204`;
