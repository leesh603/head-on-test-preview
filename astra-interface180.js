...
import {getLocale,subscribe} from './i18n.js?v=306';
import {clearAircraftMatte,aircraftKey} from './aircraft.js?v=306&b=306';
import {clearCrewMatte} from './matte70.js?v=306&b=306';
import {aircraftArt} from './main-ui-art180.js?v=306';
...
const rawHangarArt={fokker:'./fokker.webp?v=306&b=306',baron_albatros:'./baron_albatros.webp?v=306&b=306',albatros_d2:'./albatros_d2.webp?v=306&b=306',nieuport_italian:'./nieuport.webp?v=306&b=306'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.webp?v=306&b=306`;
...
function installHud(){
 ...
 for(const [id,name]of [['touchSkill','active'],['touchEvade','maneuver']]){
  ...
  if(name==='active'){const f=$('central')?.classList.contains('active')?'central':'entente';
   ...
   img.src=`./augmentation-icons/emblem_bare_${f}.webp?v=306`;button.prepend(img,ring());}
