...
import {getLocale,subscribe} from './i18n.js?v=305';
import {clearAircraftMatte,aircraftKey} from './aircraft.js?v=305&b=305';
import {clearCrewMatte} from './matte70.js?v=305&b=305';
import {aircraftArt} from './main-ui-art180.js?v=305';
...
const rawHangarArt={fokker:'./fokker.webp?v=305&b=305',baron_albatros:'./baron_albatros.webp?v=305&b=305',albatros_d2:'./albatros_d2.webp?v=305&b=305',nieuport_italian:'./nieuport.webp?v=305&b=305'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.webp?v=305&b=305`;
...
function installHud(){
 ...
 for(const [id,name]of [['touchSkill','active'],['touchEvade','maneuver']]){
  ...
  if(name==='active'){const f=$('central')?.classList.contains('active')?'central':'entente';
   ...
   img.src=`./augmentation-icons/emblem_bare_${f}.webp?v=305`;button.prepend(img,ring());}
