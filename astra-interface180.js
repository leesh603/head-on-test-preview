...
import {getLocale,subscribe} from './i18n.js?v=299';
import {clearAircraftMatte,aircraftKey} from './aircraft.js?v=299&b=299';
import {clearCrewMatte} from './matte70.js?v=299&b=299';
import {aircraftArt} from './main-ui-art180.js?v=299';
...
const rawHangarArt={fokker:'./fokker.webp?v=299&b=299',baron_albatros:'./baron_albatros.webp?v=299&b=299',albatros_d2:'./albatros_d2.webp?v=299&b=299',nieuport_italian:'./nieuport.webp?v=299&b=299'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.webp?v=299&b=299`;
