...
import {getLocale,subscribe} from './i18n.js?v=318';
import {clearAircraftMatte,aircraftKey} from './aircraft.js?v=3188&b=318';
import {clearCrewMatte} from './matte70.js?v=3188&b=318';
import {aircraftArt} from './main-ui-art180.js?v=318';
...
const rawHangarArt={fokker:'./fokker.webp?v=3188&b=318',baron_albatros:'./baron_albatros.webp?v=3188&b=318',albatros_d2:'./albatros_d2.webp?v=3188&b=318',nieuport_italian:'./nieuport.webp?v=3188&b=318'};
...
function hangarArt(key){
 ...
 const src=rawHangarArt[key]||`./${hangarKeyFile[key]||key}.webp?v=3188&b=318`;
...
function installHud(){
 ...
 for(const [id,name]of [['touchSkill','active'],['touchEvade','maneuver']]){
  ...
  if(name==='active'){const f=$('central')?.classList.contains('active')?'central':'entente';
   ...
   img.src=`./augmentation-icons/emblem_bare_${f}.webp?v=318`;button.prepend(img,ring());}
