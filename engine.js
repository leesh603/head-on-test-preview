...
import {enableStageBoss,beginStageBossFrame,endStageBossFrame,stageBossSpeed,stageSpawnInterval,stageBossCollision,damageStageBoss} from './stageboss-host.js?v=201';
...
import {getPlayerMgFxTier} from './mg-fx-tiers.js?v=201';
...
Game.prototype.mgFxBonusPct=function(){return((this.damage/12)-1)*100};
Game.prototype.mgFxTier=function(){return getPlayerMgFxTier(this.mgFxBonusPct())};
