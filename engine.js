import {installRevision} from './rebalance103js?v=214&b=210';
import {installAugmentationOverhaul,AUGMENTATION_OVERHAUL_BALANCE,BUILD_IDENTITIES,BUILD_IDENTITY_LIMIT,buildIdentityFor} from './augmentation-overhaul150js?v=214';
import {enableStageBoss,beginStageBossFrame,endStageBossFrame,stageBossSpeed,stageSpawnInterval,stageBossCollision,damageStageBoss} from './stageboss-hostjs?v=214';
import {attachAircraftPersonality,installAircraftPersonality} from './aircraft-personality164js?v=214';
import {installDogfightPass,DOGFIGHT_PASS_BALANCE,DOGFIGHT_PASS_STATES,directorAircraftEligible} from './dogfight-pass165js?v=214';
import {installDogfightDefense,PURSUIT_MATCH_BALANCE} from './dogfight-defense166js?v=214';
import {installEnergyCombat,ENERGY_COMBAT_BALANCE} from './energy-combat167js?v=214';
import {installBattleDirector,BATTLE_DIRECTOR_BALANCE,BATTLE_DIRECTOR_PATTERNS} from './battle-director169js?v=214';
import {installBattlefieldEvents,BATTLEFIELD_EVENT_BALANCE,BATTLEFIELD_EVENT_TYPES} from './battlefield-events170js?v=214';
import {installRivalAce,RIVAL_ACE_BALANCE,RIVAL_ACE_PHASES} from './rival-ace171js?v=214';
