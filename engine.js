import {preparePersonalRound1918,advancePersonal1918,advanceBurns1918} from './pilot-lifecycle196.js?v=335';
import {installRevision} from './rebalance103.js?v=335&b=326';
import {installCloudCover} from './cloud-cover1.js?v=335&b=326';
import {installFleet} from './fleet-naval1.js?v=335&b=326';
import {installTrenchWar} from './trench-war1.js?v=335&b=326';
import {installCityAir} from './city-air1.js?v=335&b=326';
import {installRegionDoctrine} from './region-doctrine1.js?v=335&b=326';
import {installAugmentationOverhaul,AUGMENTATION_OVERHAUL_BALANCE,BUILD_IDENTITIES,BUILD_IDENTITY_LIMIT,buildIdentityFor} from './augmentation-overhaul150.js?v=335';
import {enableStageBoss,beginStageBossFrame,endStageBossFrame,stageBossSpeed,stageSpawnInterval,stageBossCollision,damageStageBoss} from './stageboss-host.js?v=335&b=326';
import {attachAircraftPersonality,installAircraftPersonality} from './aircraft-personality164.js?v=335';
import {installDogfightPass,DOGFIGHT_PASS_BALANCE,DOGFIGHT_PASS_STATES,directorAircraftEligible} from './dogfight-pass165.js?v=335';
import {installDogfightDefense,PURSUIT_MATCH_BALANCE} from './dogfight-defense166.js?v=335';
import {installEnergyCombat,ENERGY_COMBAT_BALANCE} from './energy-combat167.js?v=335';
import {installBattleDirector,BATTLE_DIRECTOR_BALANCE,BATTLE_DIRECTOR_PATTERNS} from './battle-director169.js?v=335';
import {installBattlefieldEvents,BATTLEFIELD_EVENT_BALANCE,BATTLEFIELD_EVENT_TYPES} from './battlefield-events170.js?v=335';
import {installRivalAce,RIVAL_ACE_BALANCE,RIVAL_ACE_PHASES} from './rival-ace171.js?v=335';
...
PILOTS.baron.cooldown=18;PILOTS.baron.skill='드라이데커';PILOTS.baron.passive='사냥 본능';PILOTS.baron.passiveDesc='강한 적을 오래 추적할수록 해당 대상에게 주는 피해가 증가합니다. 사냥감 격추 시 잠시 빨라집니다.';PILOTS.baron.desc='속도를 낮춰 극단적으로 선회합니다. 적의 후방을 잡으면 즉시 추격 가속합니다.';
