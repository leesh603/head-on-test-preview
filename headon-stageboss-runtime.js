import {BOSS_CATALOG,STAGES,createBossEncounter} from './headon-stageboss-patterns.js?v=184';
import {BossHazards} from './headon-stageboss-hazards.js?v=116&b=117';
...
export class BossStages {
  constructor({teamFaction,stageIndex=0,loopIndex=0,rng=Math.random}) {
    ...
    Object.assign(this,{teamFaction,stageIndex,loopIndex,rng});this.order=[0,1,6,2,4,5,3];this.orderPosition=this.order.indexOf(stageIndex);this.phase='explore';this.encounter=null;
  }
