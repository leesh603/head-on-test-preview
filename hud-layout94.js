...
const sheet=document.createElement('link');sheet.rel='stylesheet';sheet.href='./reinforcement151.css?v=340';if(!document.querySelector('link[href*="reinforcement151.css"]'))document.head.append(sheet);
const polished=document.createElement('link');polished.rel='stylesheet';polished.href='./flight-polish156.css?v=340';if(!document.querySelector('link[href*="flight-polish156.css"]'))document.head.append(polished);
const install=()=>{
