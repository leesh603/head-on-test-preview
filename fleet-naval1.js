...
import {PLANES} from './engine.js?v=334&b=326';
...
let _shipImgs={};
function shipImg(key){let im=_shipImgs[key];if(im===undefined){im=new Image();im.src=`./${key}.webp?v=334&b=326`;im.onload=()=>{_shipImgs[key]=im};_shipImgs[key]=im}return im}
