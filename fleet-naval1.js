...
import {PLANES} from './engine.js?v=323&b=323';
...
let _shipImgs={};
function shipImg(key){let im=_shipImgs[key];if(im===undefined){im=new Image();im.src=`./${key}.webp?v=323&b=323`;im.onload=()=>{_shipImgs[key]=im};_shipImgs[key]=im}return im}
