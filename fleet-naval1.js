...
import {PLANES} from './engine.js?v=307&b=307';
...
let _shipImgs={};
function shipImg(key){let im=_shipImgs[key];if(im===undefined){im=new Image();im.src=`./${key}.webp?v=307&b=307`;im.onload=()=>{_shipImgs[key]=im};_shipImgs[key]=im}return im}
