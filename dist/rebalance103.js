...
export function installRevision(Game,PLANES,WEAPONS,PILOTS,PILOT_PLANES,LEGENDARIES,UPGRADES){
 ...
 const passives={baron:['꼬리 잡기','이동속도 +10%, 후방 공격 피해 +30%.'],fonck:['명사수','기관총 피해 +15%, 사거리 +25%.'],voss:['고독한 늑대','400 범위 적 1기당 공격력·속도·선회 +4%, 최대 +24%.'],boelcke:['디 딕타 뵐케','360 범위 아군의 사격 피해 +25%.'],collishaw:['검은 편대','검은 삼엽기 윙맨 2기와 상시 출격.'],baracca:['기사도의 결투','적과 정면으로 마주칠 때 공격 피해 +30%.'],udet:['공중 곡예사','현재 체력이 100보다 낮으면 부족한 체력 1당 공격력 +0.5%, 속도·선회 +0.3%.'],guynemer:['모퇴르 카농','4초마다 피해 90의 대형 관통 기관포 발사.'],bishop:['초근접사격','기관총 공격력 +80%, 사거리 −55%.'],goering:['백색 편대 · 출격','백색 윙맨 2기와 상시 출격.'],immelmann:['독일의 독수리','선회기동·임멜만 턴 이후 3초간 공격력·공격속도·속도·선회 +20%.'],mannock:['외눈의 에이스','기관총 사거리 −55%.'],mckeever:['후방사수 · 파월','전방과 후방 동시 사격.'],huffzky:['매와 모기','전방과 후방 동시 사격.'],hawker:['빅토리아 십자훈장 수훈자','선회 속도 손실 −25%. 직진 유지 시 최대 속도 +20%.'],berthold:['철혈의 에이스','체력 50% 이하에서 받는 피해 25% 감소.']};
