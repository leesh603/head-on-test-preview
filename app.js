import {drawGrenade,drawGrenadeBlast,drawAmatolBlast,drawFxExplosion} from './weapon-effects156.js?v=288&b=288';
import {fx,fxReady,fxTint,FX56} from './fx-art.js?v=282';
...
import {playerPose,drawPlayerAura,drawPetalParticle,drawRedGhosts162} from './player-effects129.js?v=288&b=288';
import {drawStageBoss,updateStageBossHud,paintCity,paintSky,prepareStageBossAssets} from './stageboss-view.js?v=288&b=288';
import {enableStageBoss,stageBossBounds} from './stageboss-host.js?v=288&b=288';
...
import {CoopGame,coopPlane} from './coop-engine.js?v=288&b=288';
import {CoopInput,coopRecord,saveCoopLocal,COOP_RECORD_KEYS} from './coop-input.js?v=214';
import {drawCoop} from './coop-view.js?v=288&b=288';
import {drawSunStrike} from './sun-strike71.js?v=288&b=288';
import {drawEnemyProjectile,drawCannonProjectile,drawBattlefieldFire,friendlyTracerColor} from './projectiles.js?v=288&b=288';
...
import {drawGas} from './gas-view.js?v=288&b=288';
import {missionNavigation,drawMissionRadar} from './navigation.js?v=288&b=288';
import {drawBattlefieldSprite} from './battlefield-art.js?v=288&b=288';
import {CampaignGame,STAGES,stageFaction,historicalAircraft,sortieAircraft,liveryVariant} from './campaign.js?v=288&b=288';
import {drawCampaign} from './campaign-view.js?v=288&b=288';
import {campaignArtReady} from './aircraft.js?v=288&b=288';
import {drawGameIcon,drawSpecialAmmoIcon,iconsReady} from './icons.js?v=216';
import {BattleMusic,musicModeForGame} from './music.js?v=288&b=288';
import {sfx,setSfxMuted} from './sfx.js?v=288&b=288';
import {portraitSources,portraitsReady} from './portraits.js?v=288&b=288';
import {BOSS_CATALOG} from './headon-stageboss-patterns.js?v=288&b=288';
import {drawEquipment} from './equipment.js?v=288&b=288';
import {installHeadOnElitePatch,createEliteAssets,renderEliteLayer} from './elite-patch/module/index.js?v=214';
import{planeSprite,aircraftReady,aircraftKey,hangarArtReady}from './aircraft.js?v=288&b=288';
import{Game,PLANES,PILOTS,UPGRADES,WEAPONS,PILOT_PLANES,upgradeDescription,pilotLoadout,pilotAircraftName,TAILING_BALANCE,SPECIAL_AMMO,enemyAircraftScale,LEGENDARY_DEFENSE_BALANCE,LEGENDARY_BALANCE}from './engine.js?v=288&b=288';
import {AUGMENTATION_OVERHAUL_BALANCE}from'./augmentation-overhaul150.js?v=281';
import {drawCloudCover}from'./cloud-cover1.js?v=288&b=288';
import {drawFleetLayer}from'./fleet-naval1.js?v=288&b=288';
import {drawTrenchLayer}from'./trench-war1.js?v=288&b=288';
import {drawCityAirLayer}from'./city-air1.js?v=288&b=288';
...
function renderCoopSetup(){
 ...
 $('coopPortrait2').src=portraitSources[coopPilot2]||'portrait-'+coopPilot2+'.webp?v=226&b=226';$('coopPortrait2').alt=PILOTS[coopPilot2].name;$('coopPortrait2').style.setProperty('--pilot-choice-scale',choicePortraitScale(coopPilot2));
...
function coopEvents(){
 ...
 for(const e of g.events.splice(0)){
  ...
  if(e.type==='skill'&&e.ownerId){const p=g.player(e.ownerId),id=p.id;coopCutinEnds[id]=g.t+2.1;$(id+'CutinPortrait').src=portraitSources[p.pilot]||'portrait-'+p.pilot+'.webp?v=226&b=226';$(id+'CutinPortrait').alt=PILOTS[p.pilot].name;$(id+'CutinName').textContent=id.toUpperCase()+' · '+p.nickname;$(id+'CutinSkill').textContent=pilotLoadout(p.pilot,p.plane).skill;sfx('skill')}
  if(e.type==='bossArrival'){bossArrivalUntil=g.t+4.5;bossCardFrom=performance.now();$('bossName').textContent=arrivalCount>1?t('warning.aceGroup'):e.name;$('bossPortrait').src=portraitSources[e.pilot]||'portrait-'+e.pilot+'.webp?v=226&b=226';$('bossArrivalDetail').textContent=arrivalCount>1?t('warning.aceApproach',{count:arrivalCount}):t('coop.aceCoop');bossCutinUntil=bossCardFrom+2600;setBossCutin($('bossPortrait').src,$('bossName').textContent,'ENEMY ACE · 적 에이스',$('bossArrivalDetail').textContent);setBgmMode('boss')}
