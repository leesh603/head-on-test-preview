import {drawGrenade,drawGrenadeBlast,drawAmatolBlast,drawFxExplosion} from './weapon-effects156.js?v=283&b=283';
...
import {playerPose,drawPlayerAura,drawPetalParticle,drawRedGhosts162} from './player-effects129.js?v=283&b=283';
import {drawStageBoss,updateStageBossHud,paintCity,paintSky,prepareStageBossAssets} from './stageboss-view.js?v=284&b=284';
import {enableStageBoss,stageBossBounds} from './stageboss-host.js?v=284&b=284';
...
import {CoopGame,coopPlane} from './coop-engine.js?v=283&b=283';
import {CoopInput,coopRecord,saveCoopLocal,COOP_RECORD_KEYS} from './coop-input.js?v=214';
import {drawCoop} from './coop-view.js?v=283&b=283';
import {drawSunStrike} from './sun-strike71.js?v=283&b=283';
...
import {CampaignGame,STAGES,stageFaction,historicalAircraft,sortieAircraft,liveryVariant} from './campaign.js?v=283&b=283';
import {drawCampaign} from './campaign-view.js?v=283&b=283';
import {campaignArtReady} from './aircraft.js?v=283&b=283';
...
import {sfx,setSfxMuted} from './sfx.js?v=282&b=282';
import {portraitSources,portraitsReady} from './portraits.js?v=226&b=226';
...
import{planeSprite,aircraftReady,aircraftKey,hangarArtReady}from './aircraft.js?v=283&b=283';
import{Game,PLANES,PILOTS,UPGRADES,WEAPONS,PILOT_PLANES,upgradeDescription,pilotLoadout,pilotAircraftName,TAILING_BALANCE,SPECIAL_AMMO,enemyAircraftScale,LEGENDARY_DEFENSE_BALANCE,LEGENDARY_BALANCE}from './engine.js?v=283&b=283';
import {AUGMENTATION_OVERHAUL_BALANCE}from'./augmentation-overhaul150.js?v=281';
import {drawCloudCover}from'./cloud-cover1.js?v=283&b=283';
import {drawFleetLayer}from'./fleet-naval1.js?v=283&b=283';
import {drawTrenchLayer}from'./trench-war1.js?v=283&b=283';
import {drawCityAirLayer}from'./city-air1.js?v=283&b=283';
...
const _hud51=hud;
const RELIC_COOLDOWNS={grunkreuz:{rem:g=>g.grunkreuzOn>0?0:(g.grunkreuzOff??0),iv:()=>LEGENDARY_DEFENSE_BALANCE.grunkreuzOffDuration},rankinShell:{rem:g=>g.rankinTimer??0,iv:()=>LEGENDARY_DEFENSE_BALANCE.rankinInterval},kaiserFog:{rem:g=>g.kaiserFogTimer??0,iv:()=>LEGENDARY_DEFENSE_BALANCE.fogInterval},motorCannon:{rem:g=>g.motorCannonTimer??0,iv:g=>g.ordnanceInterval?g.ordnanceInterval(LEGENDARY_BALANCE.motorCannonInterval):LEGENDARY_BALANCE.motorCannonInterval},sparkPlug:{rem:g=>g.mccuddenRepairTimer??0,iv:()=>AUGMENTATION_OVERHAUL_BALANCE.repairInterval}};
