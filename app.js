...
import {CoopGame,coopPlane} from './coop-engine.js?v=340&b=340';
import {CoopInput,coopRecord,saveCoopLocal,COOP_RECORD_KEYS} from './coop-input.js?v=340';
import {drawCoop} from './coop-view.js?v=340&b=340';
import {drawSunStrike} from './sun-strike71.js?v=340&b=340';
...
import {CampaignGame,STAGES,stageFaction,historicalAircraft,sortieAircraft,liveryVariant} from './campaign.js?v=340&b=340';
import {drawCampaign} from './campaign-view.js?v=340&b=340';
...
import{Game,PLANES,PILOTS,UPGRADES,WEAPONS,PILOT_PLANES,upgradeDescription,pilotLoadout,pilotAircraftName,TAILING_BALANCE,SPECIAL_AMMO,enemyAircraftScale,LEGENDARY_DEFENSE_BALANCE,LEGENDARY_BALANCE}from './engine.js?v=340&b=340';
import {AUGMENTATION_OVERHAUL_BALANCE}from'./augmentation-overhaul150.js?v=340';
import {drawCloudCover}from'./cloud-cover1.js?v=340&b=340';
import {drawFleetLayer}from'./fleet-naval1.js?v=340&b=340';
import {drawTrenchLayer}from'./trench-war1.js?v=340&b=340';
import {drawCityAirLayer}from'./city-air1.js?v=340&b=340';
...
function resize(){let r=canvas.getBoundingClientRect();const nextW=Math.max(240,Math.round(r.width)),nextH=Math.max(240,Math.round(r.height));W=nextW;H=nextH;if(canvas.width!==nextW)canvas.width=nextW;if(canvas.height!==nextH)canvas.height=nextH;ctx.imageSmoothingEnabled=false;ctx.imageSmoothingQuality='high'}new ResizeObserver(resize).observe($('viewport'));
