import {drawGrenade,drawGrenadeBlast,drawAmatolBlast,drawFxExplosion} from './weapon-effects156.js?v=286&b=286';
...
import {playerPose,drawPlayerAura,drawPetalParticle,drawRedGhosts162} from './player-effects129.js?v=286&b=286';
import {drawStageBoss,updateStageBossHud,paintCity,paintSky,prepareStageBossAssets} from './stageboss-view.js?v=286&b=286';
import {enableStageBoss,stageBossBounds} from './stageboss-host.js?v=286&b=286';
...
import {CoopGame,coopPlane} from './coop-engine.js?v=286&b=286';
import {CoopInput,coopRecord,saveCoopLocal,COOP_RECORD_KEYS} from './coop-input.js?v=214';
import {drawCoop} from './coop-view.js?v=286&b=286';
import {drawSunStrike} from './sun-strike71.js?v=286&b=286';
import {drawEnemyProjectile,drawCannonProjectile,drawBattlefieldFire,friendlyTracerColor} from './projectiles.js?v=286&b=286';
...
import {drawGas} from './gas-view.js?v=286&b=286';
import {missionNavigation,drawMissionRadar} from './navigation.js?v=286&b=286';
import {drawBattlefieldSprite} from './battlefield-art.js?v=286&b=286';
import {CampaignGame,STAGES,stageFaction,historicalAircraft,sortieAircraft,liveryVariant} from './campaign.js?v=286&b=286';
import {drawCampaign} from './campaign-view.js?v=286&b=286';
import {campaignArtReady} from './aircraft.js?v=286&b=286';
import {drawGameIcon,drawSpecialAmmoIcon,iconsReady} from './icons.js?v=216';
import {BattleMusic,musicModeForGame} from './music.js?v=286&b=286';
import {sfx,setSfxMuted} from './sfx.js?v=286&b=286';
import {portraitSources,portraitsReady} from './portraits.js?v=286&b=286';
import {BOSS_CATALOG} from './headon-stageboss-patterns.js?v=286&b=286';
import {drawEquipment} from './equipment.js?v=286&b=286';
import {installHeadOnElitePatch,createEliteAssets,renderEliteLayer} from './elite-patch/module/index.js?v=214';
import{planeSprite,aircraftReady,aircraftKey,hangarArtReady}from './aircraft.js?v=286&b=286';
import{Game,PLANES,PILOTS,UPGRADES,WEAPONS,PILOT_PLANES,upgradeDescription,pilotLoadout,pilotAircraftName,TAILING_BALANCE,SPECIAL_AMMO,enemyAircraftScale,LEGENDARY_DEFENSE_BALANCE,LEGENDARY_BALANCE}from './engine.js?v=286&b=286';
import {AUGMENTATION_OVERHAUL_BALANCE}from'./augmentation-overhaul150.js?v=281';
import {drawCloudCover}from'./cloud-cover1.js?v=286&b=286';
import {drawFleetLayer}from'./fleet-naval1.js?v=286&b=286';
import {drawTrenchLayer}from'./trench-war1.js?v=286&b=286';
import {drawCityAirLayer}from'./city-air1.js?v=286&b=286';
