import {planeSprite,registerCampaignSpriteAliases} from './aircraft.js?v=184';
import {SPRITE_ALIASES} from './campaign.js?v=174';
...
import {missionNavigation,navigationScreenPoint} from './navigation.js?v=128';
