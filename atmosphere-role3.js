...
export function drawGasVeil3(c,z,x,y,time=0,boundary=true){
 ...
 roleDraw(c,'gasCloud'+frame,x,y,diameter,diameter,turn,.42*fade);
 roleDraw(c,'gasCloud'+Math.min(3,frame+1),x+Math.cos(turn+2)*z.r*.28,y+Math.sin(turn+2)*z.r*.22,diameter*.8,diameter*.68,-turn,.24*fade);
