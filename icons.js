...
const atlasReady=Promise.all([
 loadIconAtlas('./icons51.webp?v=326',5,4,keys,true),
 loadIconAtlas('./controls53.webp?v=326',2,2,['control','turn','command','cooldown']),
 loadIconAtlas('./special-ammo-icons92.webp?v=326',2,2,['ammo-incendiary','ammo-armorPiercing','ammo-tracer','ammo-explosive'],true),
 loadIconAtlas('./legendary-icons103.webp?v=326',3,1,['boelckeDicta','fogCompass','rearGunner'],true),
 loadIconAtlas('./gun-atlas114.webp?v=326',4,1,['gun-vickers','gun-spandau','gun-lewis','gun-parabellum'],true),
 loadIconAtlas('./legendary-icons109.webp?v=326',6,1,['goeringBaton','motorCannon','quadLewis','cow37','rankinShell','kaiserFog'],true),
...
export const iconsReady=atlasReady.then(async results=>{
 const direct=await Promise.all(Object.entries(DIRECT_ICONS).map(([key,file])=>loadDirectIcon('./augmentation-icons/'+file+'?v=326',key)));
