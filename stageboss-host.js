import {StageBossAddon,normalSpawnInterval} from './headon-stageboss-runtime.js?v=213';
import {BOSS_CATALOG} from './headon-stageboss-patterns.js?v=213';
import {waterBarrierDisplacement} from './headon-stageboss-render.js?v=213';
